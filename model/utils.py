...
# H36M skeleton definition (17 joints)
h36m_skeleton_parents = [-1, 0, 1, 2, 0, 4, 5, 0, 7, 8, 9, 8, 11, 12, 8, 14, 15]
...
def adj_mx_from_skeleton(parents):
    """Create adjacency matrix from skeleton structure"""
...
def adj_mx_from_skeleton_temporal(num_frame, parents=None):
    """Create temporal adjacency matrix"""
    edges = [[i, i+1] for i in range(num_frame-1)]
    return adj_mx_from_edges(num_frame, edges, sparse=False)
